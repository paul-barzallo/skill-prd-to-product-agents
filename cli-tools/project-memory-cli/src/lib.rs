...
pub use cli::Cli;
use output::CommandStatus;

pub struct RunOutcome {
    pub exit_code: i32,
}

fn status_from_warnings(warnings: &[String]) -> CommandStatus {
...
pub fn run(cli: Cli) -> Result<RunOutcome> {
    ...
    match command {
        ...
        cli::Commands::Validate(args) => {
            ...
            output::print_json("validate", &project_root, status, Vec::new(), &report)?;
